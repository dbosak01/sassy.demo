...
#### Description: AE Table by Severity Grade 
####
####              Wide table: 4 pages wide and 4 pages long for 16 total pages
####              Overall AE totals and totals by SOC 
...
proc_freq(ae_sub, tables = "AESEV", by = v(ARM),
          options = out) -> allfreq 
...
rpt <- create_report("output/ProcsDemoAE.rtf", output_type = "RTF", font = "Arial") |> 
